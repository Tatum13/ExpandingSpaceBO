...
public class UseElevatorL1Script : MonoBehaviour
{
    ...
    void Start()
    {
        down = GameObject.Find("Elevator/Level 1/down");
        up = GameObject.Find("Elevator/Level 1/up");
    }
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Kayla").transform.position = new Vector2(3.18f, 4.58f);
        }
        if (Input.GetKeyDown(KeyCode.UpArrow) && aceInElevator)
        {
            GameObject.Find("Ace").transform.position = new Vector2(3.18f, 4.58f);
        }

        // Moving down one leven when pressing DownArrow
        if (Input.GetKeyDown(KeyCode.DownArrow) && eliasInElevator)
        {
            GameObject.Find("Elias").transform.position = new Vector2(3.18f, -13.28f);
        }
        if (Input.GetKeyDown(KeyCode.DownArrow) && kaylaInElevator)
        {
            GameObject.Find("Kayla").transform.position = new Vector2(3.18f, -13.28f);
        }
        if (Input.GetKeyDown(KeyCode.DownArrow) && aceInElevator)
        {
            GameObject.Find("Ace").transform.position = new Vector2(3.18f, -13.28f);
        }
    }
}
